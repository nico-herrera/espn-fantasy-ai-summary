...
{:else if weeklyData}
	<div class="container mx-auto px-4 py-8">
		...
		<div class="bg-white shadow-md rounded px-8 pt-6 pb-8 mb-4">
			...
			<p class="text-gray-700 text-base">{weeklyData.summary.overallSummary}</p>
		</div>
